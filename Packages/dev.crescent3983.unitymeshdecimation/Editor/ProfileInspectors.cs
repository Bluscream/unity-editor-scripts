...
namespace UnityMeshDecimation.Editor
{
    ...
    public class DefaultMeshDecimationInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EasyGUILayout.BoolField("Preserve Blend Shapes", ref collapseParam.PreserveBlendShapes, this._mTarget);
    ...
    public class GBVSMeshDecimationInspector : UnityEditor.Editor
    {
